...
function passwordChar(){
  var charLength = window.prompt( "Please let me know how many caracters you'd like to have in password? please enter the number which is between 8 and 128.", "8"
  ); if (charLength < 8){
